                                                ...
                                                <div class="row">
                                                    <section class="col col-6">
                                                        ...
                                                        <label class="input">
                                                            ...
                                                            <input type="text" name="shop_name" placeholder="Enter shop/company name" required>
                                                        </label>
                                                    </section>
                                                    <section class="col col-6">
                                                        ...
                                                        <label class="input">
                                                            ...
                                                            <input type="text" name="name" placeholder="Enter contact person name" required>
                                                        </label>
                                                    </section>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <section class="col col-12">
                                                        ...
                                                        <label class="textarea">
                                                            ...
                                                            <textarea name="adress" rows="3" placeholder="Enter complete address" required></textarea>
                                                        </label>
                                                    </section>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6">
                                                        <div id="logo-preview" style="display: none;">
                                                            <label class="label">Logo Preview</label>
