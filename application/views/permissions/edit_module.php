                        ...
                        <div>
                            <div class="widget-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="module_name" value="<?php echo $module['module_name']; ?>" placeholder="Enter module name (e.g., orders)" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="module_display_name" value="<?php echo $module['module_display_name']; ?>" placeholder="Enter display name (e.g., Orders)" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="module_description" rows="3" placeholder="Describe the module"><?php echo $module['module_description']; ?></textarea>
