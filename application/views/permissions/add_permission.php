                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark">
                        ...
                        <div>
                            <div class="widget-body">
                                <?php echo form_open('permissions/add_permission', ['class' => 'form-horizontal', 'id' => 'add-permission-form']); ?>
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="module_id" required>
                                            ...
                                            <?php foreach ($modules as $module): ?>
                                                <option value="<?php echo $module['module_id']; ?>" <?php echo set_select('module_id', $module['module_id']); ?>><?php echo htmlspecialchars($module['module_display_name']); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="permission_name" value="<?php echo set_value('permission_name'); ?>" placeholder="Enter permission name (e.g., view_orders)" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="permission_display_name" value="<?php echo set_value('permission_display_name'); ?>" placeholder="Enter display name (e.g., View Orders)" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="permission_description" rows="3" placeholder="Describe the permission" required><?php echo set_value('permission_description'); ?></textarea>
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="permission_type" required>
                                            ...
                                            <?php foreach ($permission_types as $type): ?>
                                                <option value="<?php echo $type; ?>" <?php echo set_select('permission_type', $type); ?>><?php echo htmlspecialchars(ucfirst($type)); ?></option>
                                            <?php endforeach; ?>
                                        </select>
