...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><?php echo $this->lang->line("home"); ?></li><li>All Brands</li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="onoffswitch">
                                                                        <input class="onoffswitch-checkbox changestatusbrand" id="<?php echo $value['brand_id'] ?>" type="checkbox" <?php if ($value["status"] == "1") { ?>checked="checked" value="1"<?php } else { ?>value='0'<?php } ?> >
                                                                        <label class="onoffswitch-label" for="<?php echo $value['brand_id'] ?>"> 
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li>
                                                                                <a href="<?php echo site_url(); ?>/brands/editbrand/<?php echo $value['brand_id']; ?>">Edit Brand</a>
                                                                            </li>
