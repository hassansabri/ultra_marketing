                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo  getCatgoryName($value['parent_id']); ?></td>
                                                                <td>
                                                                    <span class="onoffswitch">
                                                                        <input class="onoffswitch-checkbox changestatuscategory" id="<?php echo $value['category_id'] ?>" type="checkbox" <?php if ($value["category_status"] == "1") { ?>checked="checked" value="1"<?php } else { ?>value='0'<?php } ?> >
                                                                        <label class="onoffswitch-label" for="<?php echo $value['category_id'] ?>"> 
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li>
                                                                                <a href="<?php echo site_url(); ?>/categories/editcategory/<?php echo $value['category_id']; ?>">Edit Category</a>
                                                                            </li>
