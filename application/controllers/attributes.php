...
$data["all_units"]=   $this->input->post('unit_id');
           $this->model_attributes->submitattributes($data['all_units'],$item_id,'unit');
...
for($i=0; $i<sizeof($data); $i++){
    ...
    public function add_new_attribute(){
       ...
       $this->data["all_units"] = $this->model_attributes->getunits('1');
       $this->data['get_item_units'] = $this->model_attributes->getitemunits($itemid);
