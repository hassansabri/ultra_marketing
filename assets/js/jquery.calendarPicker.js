    ...
    calendar.changeDate = function (date) {
        ...
        var fillYears = function (date) {
            ...
            for (var i = year - options.years; i <= year + options.years; i++) {
                ...
                var d = new Date(date);
                d.setFullYear(i);
                var span = $("<span style='display:none;'>").addClass("calElement").attr("millis", d.getTime()).html(i).css("width", w);
                if (d.getYear() == t.getYear())
                    span.addClass("todays");
...
//                span.addClass("");
        ...
        var fillMonths = function (date) {
            ...
            for (var i = -options.months; i <= options.months; i++) {
                ...
                var span = $("<span>").addClass("calElement").attr("millis", d.getTime()).html(options.monthNames[d.getMonth()] + '-' + globarray[counter++]).css("width", w);
        ...
        var fillDays = function (date) {
            ...
            for (var i = -options.days; i <= options.days; i++) {
                ...
                var d = new Date(date);
                d.setDate(day + i)
                var span = $("<span  style='background:transparent;'>").addClass("calElement").attr("millis", d.getTime())
